...
public class Main extends Application {
	...
	public void start(Stage primaryStage) {
		try {
			...
			root = FXMLLoader.load(getClass().getClassLoader().getResource("MainGUI.fxml"), resources);
			scene = new Scene(root);
			rootPane = (AnchorPane) scene.lookup("#rootPane");

			loginPane = (AnchorPane) FXMLLoader.load(getClass().getClassLoader().getResource("Login.fxml"), resources);
			searchPane = (AnchorPane) FXMLLoader.load(getClass().getClassLoader().getResource("Search.fxml"),
					resources);
			menuPane = (AnchorPane) FXMLLoader.load(getClass().getClassLoader().getResource("Menu.fxml"), resources);
			passwordPane = (AnchorPane) FXMLLoader.load(getClass().getClassLoader().getResource("Password.fxml"),
					resources);
			writePane = (AnchorPane) FXMLLoader.load(getClass().getClassLoader().getResource("Write.fxml"), resources);
			deletePane = (AnchorPane) FXMLLoader.load(getClass().getClassLoader().getResource("Delete.fxml"),
					resources);
			choosePasswordPane = (AnchorPane) FXMLLoader
					.load(getClass().getClassLoader().getResource("ChoosePass.fxml"), resources);
			chooseHintPane = (AnchorPane) FXMLLoader.load(getClass().getClassLoader().getResource("ChooseHint.fxml"),
					resources);
			securityNoticePane = (AnchorPane) FXMLLoader
					.load(getClass().getClassLoader().getResource("SecurityNotice.fxml"), resources);
